function [social_names,temp_unique_names] = load_social_group(BeA_struct_path,fileformat)
%{
    Transfer single BeA_struct name to social name
    social_names: [your group,animal instance 1, animal instance 2.....]
%}
fileFolder = fullfile(BeA_struct_path);
dirOutput = dir(fullfile(fileFolder,['*',fileformat]));
