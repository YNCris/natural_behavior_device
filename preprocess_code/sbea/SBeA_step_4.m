...
videopath = rootpath;
cutvideoname = 'sbeapath_20250625_watershed';
mkdir(save_path)
...
save([save_path,'\SBeA_data_sample_cell_20250625.mat'],'data_sample_cell');
save([save_path,'\SBeA_dist_mat_all_20250625.mat'],'dist_mat_all','-v7.3');
save([save_path,'\SBeA_wc_struct_20250625.mat'],'wc_struct');
%% cut videos
